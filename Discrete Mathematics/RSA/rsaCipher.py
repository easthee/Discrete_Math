...
def main():
    ...
    if mode == 'encrypt':
        message = '''"I love quantum mechanics and general relativity." -Donghee Han "He was born in 2000 and is a third year student at Chung-Ang University." -Donghee Han'''
